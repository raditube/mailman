<template>
  <svg id="loading-spinner" class="verify" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 48 48">
  <defs>
    <linearGradient id="spinner-gradient-a" x1="49.892%" x2="55.03%" y1="58.241%" y2="89.889%">
      <stop offset="0%" stop-color="white" />
      <stop offset="22.44%" stop-opacity=".59" stop-color="white" />
